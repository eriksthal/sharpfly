...
import { levelsEndpoint, disciplinesEndpoint, locationsEndpoint, agesEndpoint } from '../../constants/config'
...
class ClassFilter extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {locationFilter: '', disciplineFilter: [], levelFilter: '', ageFilter: '', levels:[], disciplines:[], locations:[], ages:[]};
    }
            ...
            <Paper className="class-filter__paper" elevation={1}>
                <div className="class-filter__filter-main-wrapper">
                    ...
                    <FormControl className={classes.formControl}>
                        <InputLabel htmlFor="select-multiple-checkbox">{english.discipline_filter_text}</InputLabel>
                        <Select
                            multiple
                        ...
                        >
                            ...
                            <MenuItem key={discipline.disciplineId} value={discipline.disciplineName}>
                                <Checkbox checked={this.props.disciplineFilter.indexOf(discipline.disciplineName) > -1} />
                    ...
                    <div className="class-filter__filter-container">
                        <FormControl className={classes.formControl}>
                            <InputLabel htmlFor="location">{english.location_filter_text}</InputLabel>
                            <Select
                                multiple
                            ...
                            >
                                ...
                                <MenuItem key={location.locationId} value={location.locationName}>
                                    <Checkbox checked={this.props.locationFilter.indexOf(location.locationName) > -1} />
                    ...
                    <div className="class-filter__filter-container">
                        <FormControl className={classes.formControl}>
                            <InputLabel htmlFor="level">{english.level_filter_text}</InputLabel>
                            <Select
                                multiple
                            ...
                            >
                                ...
                                <MenuItem key={level.levelId} value={level.levelName}>
                                    <Checkbox checked={this.props.levelFilter.indexOf(level.levelName) > -1} />
                        ...
                        <FormControl className={classes.formControl}>
                            ...
                            >
                                ...
                                <MenuItem key={age.ageId} value={age.ageName}>
                                    <Checkbox checked={this.props.ageFilter.indexOf(age.ageName) > -1} />
