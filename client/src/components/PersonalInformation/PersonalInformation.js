                ...
                <div className="personal-information__form-fields">
                    <div className="personal-information__form-row">
                        <TextField
                            id="first-name"
                            label="First Name"
                            className={classes.textField + ' personal-information__spaced-text'}
                    ...
                    <div className="personal-information__form-row-picker">
                        ...
                        <Icon style={{marginLeft: '-20px', paddingBottom: '10px', fontSize: '20px'}}>date_range</Icon>
                    </div>
                    <div className="personal-information__form-row">
                        <TextField
                            id="street-address"
                    ...
                    <h2 className="personal-information__heading">About your parents or guardians</h2>
                    <div className="personal-information__form-row">
                        <TextField
                            id="mom-name"
